        ...
        <div className="container mx-auto px-4">
          ...
          <ScrollReveal className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Need help with your account, challenge rules, or a payout request?
              Reach out below.
            </p>
          </ScrollReveal>
          ...
          <div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <ScrollReveal delay={300}>
                <div className="bg-gradient-card rounded-2xl border border-border/50 p-6">
                  <div className="flex items-center gap-4 mb-4">
                    <div className="w-12 h-12 rounded-xl bg-gold-dark/20 flex items-center justify-center">
              ...
              <ScrollReveal delay={450}>
                <div className="bg-gradient-to-br from-primary/10 to-primary/10 rounded-2xl border border-primary/20 p-6">
