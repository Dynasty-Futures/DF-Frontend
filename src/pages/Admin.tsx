...
const statusColors: Record<string, string> = {
  ...
  "Under Review": "bg-gold-light/10 text-gold-light",
      ...
      <div className="page-transition py-12 md:py-20">
        <div className="container mx-auto px-4">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border/30 bg-muted/20">
                    <th className="text-left py-4 px-6 text-muted-foreground font-medium text-sm">
                      User ID
                    </th>
                    <th className="text-left py-4 px-6 text-muted-foreground font-medium text-sm">
                      Name
                  ...
                  {filteredUsers.map((user) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6">
                        <span
                          className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-medium ${statusColors[user.status]}`}
                        >
                          {user.status}
                        </span>
                      </td>
                      <td className="py-4 px-6">
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            size="sm"
                            variant="ghost"
                            className="h-8 px-2 text-gold-dark hover:text-gold-dark hover:bg-gold-dark/10"
                          ...
                          <Button
                            size="sm"
                            variant="ghost"
                            className="h-8 px-2 text-gold-light hover:text-gold-light hover:bg-gold-light/10"
          ...
          <p className="text-xs text-muted-foreground mt-6 text-center">
            This admin panel is for internal use only. Actions will be connected
