...
export type PlanType = "Standard" | "Advanced" | "Builder";
...
export const mockAuditLogs: MockAuditLog[] = [
  ...
  },
  {
    ...
    targetType: "User",
    targetId: "USR-013",
    summary: "New Builder plan subscription",
    severity: "Info",
    source: "API",
  },
];
...
export const mockAnnouncements: MockAnnouncement[] = [
  ...
  },
  {
    ...
    message: "Starting Jan 15, all plans follow the 5-day payout cycle requirement.",
    severity: "Warning",
    target: "Funded Only",
    status: "Live",
...
export const mockPlans: MockPlan[] = [
  ...
  // Builder Plans (evaluation model)
  {
    id: "PLAN-009",
    name: "Builder",
    accountSize: "$25,000",
...
export const mockPromoCodes: MockPromoCode[] = [
  {
    ...
    usageLimit: 100,
    usageCount: 87,
    eligiblePlans: ["Standard", "Advanced", "Builder"],
    startDate: daysAgoDate(14),
