...
const statusStyles: Record<string, string> = {
  ...
  Evaluation: "bg-primary/20 text-primary border-primary/30",
  ...
  EVALUATION: "bg-primary/20 text-primary border-primary/30",
  PHASE_2: "bg-primary/20 text-primary border-primary/30",
...
export function AdminSeverityBadge({
  severity,
  className,
}: AdminSeverityBadgeProps) {
  return (
    <Badge
      variant="outline"
...
export function AdminConfidenceBadge({
  confidence,
  className,
}: AdminConfidenceBadgeProps) {
  return (
    <Badge
      variant="outline"
      className={cn(
