...
export function AdminProducts() {
  ...
  const planColumns: Column<MockPlan>[] = [
    {
      ...
      header: "Plan",
      sortable: true,
      render: (item) => <AdminPlanBadge plan={item.name} />,
    },
    ...
    },
    {
      ...
      header: "Activation",
      render: (item) =>
        item.activationFee > 0 ? `$${item.activationFee}` : "—",
    },
    {
      key: "evalReset",
      header: "Eval Reset",
      render: (item) => (item.evalReset > 0 ? `$${item.evalReset}` : "—"),
    },
    {
      key: "fundedReset",
      header: "Funded Reset",
      render: (item) => `$${item.fundedReset}`,
    },
    {
      key: "profitTarget",
      header: "Profit Target",
      render: (item) => formatCurrency(item.profitTarget),
    },
    {
      key: "maxDrawdown",
      header: "Drawdown",
      render: (item) => formatCurrency(item.maxDrawdown),
    },
    {
      key: "dailyLossLimit",
      header: "DLL",
      render: (item) => formatCurrency(item.dailyLossLimit),
    },
    {
      key: "payoutType",
      header: "Payout",
  ...
  const promoColumns: Column<MockPromoCode>[] = [
    ...
    {
      key: "eligiblePlans",
      header: "Eligible Plans",
      render: (item) => item.eligiblePlans.join(", "),
    },
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-muted/10 border border-border/30">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Allow traders to request 5-day payouts
                  </p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-muted/10 border border-border/30">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Accept new Standard plan signups
                  </p>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between p-4 rounded-lg bg-muted/10 border border-border/30">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Accept new Advanced plan signups
                  </p>
                </div>
                <Switch
              ...
              <div className="mt-6 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      type="number"
                      defaultValue={editPlan.activationFee}
                      className="mt-1"
                    />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      type="number"
                      defaultValue={editPlan.evalReset}
                      className="mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      type="number"
                      defaultValue={editPlan.fundedReset}
                      className="mt-1"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      type="number"
                      defaultValue={editPlan.maxDrawdown}
                      className="mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      type="number"
                      defaultValue={editPlan.dailyLossLimit}
                      className="mt-1"
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-2 pt-4">
                  ...
                  <Button onClick={() => setEditPlan(null)} className="flex-1">
                    Save Changes
                  </Button>
                </div>
              </div>
