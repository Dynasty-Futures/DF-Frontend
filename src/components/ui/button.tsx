  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-primary/40 bg-transparent hover:bg-primary/10 hover:border-primary/70 hover:shadow-lg hover:shadow-primary/15 hover:scale-[1.02] active:scale-[0.98]",
        secondary:
        ...
        gradient:
          "bg-gradient-to-r from-primary via-gold-light to-primary bg-[length:200%_100%] text-primary-foreground hover:shadow-lg hover:shadow-primary/30 hover:scale-[1.02] active:scale-[0.98] animate-gradient-flow",
        "gradient-outline":
          "border-2 border-primary/50 bg-transparent text-primary hover:bg-primary/10 hover:border-primary hover:shadow-lg hover:shadow-primary/20 hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
