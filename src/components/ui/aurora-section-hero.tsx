...
const BACKGROUND_BEAM_COUNT = 20
...
const BackgroundScene: React.FC<BackgroundSceneProps> = ({
  ...
  useEffect(() => {
    const generated = Array.from({ length: beamCount }).map((_, i) => {
      ...
      const dropDur = Math.random() * 3 + 3    // 3–6s (unused 3rd value, ignored by CSS)
  ...
  return (
    <div className="scene" role="presentation" aria-hidden="true">
      <div className="floor" />
