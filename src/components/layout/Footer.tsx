      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
          ...
          <div>
            ...
            >
              <img 
                src={logo} 
                alt="Dynasty Futures" 
                className="h-52 md:h-64 w-auto transition-transform duration-300 group-hover:scale-105 logo-blend"
              />
            </Link>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="text-primary">
                    <path d="M10 2l7 3v5c0 4-3 7-7 8-4-1-7-4-7-8V5l7-3z" fill="hsl(142 76% 45% / 0.2)" stroke="currentColor" strokeWidth="1.5"/>
                    <path d="M7 10l2 2 4-4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <div>
                  <h4 className="font-semibold text-foreground text-sm">Important Legal Disclosure</h4>
                  <p className="text-muted-foreground text-xs">Read our full risk disclosure and terms</p>
                </div>
              </div>
        ...
        <div className="pt-8 border-t border-border/30">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <span className="text-xs text-muted-foreground">All trading on Dynasty Futures is simulated. Payouts are based on simulated trading performance. This is not real trading, and no real capital is ever at risk.</span>
          </div>
        </div>
      </div>
