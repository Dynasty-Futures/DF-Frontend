  ...
  const upgrade = useUpgradeAccount({
    onSuccess: () => {
      toast.success("Upgrade requested", {
        description:
          "Your upgrade is pending approval. Once approved, your account becomes funded and the dashboard updates automatically.",
      });
      onOpenChange(false);
    },
          ...
          <DialogDescription asChild>
            <div className="space-y-4 pt-1">
              <p className="text-sm text-muted-foreground">
                You've hit your profit target — congratulations. Requesting an
                upgrade submits this account for review; once approved it moves
                to its funded phase, where your profits become eligible for
                payouts.
              </p>
