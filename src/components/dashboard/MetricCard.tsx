...
const MetricCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-primary via-primary to-primary/50 rounded-l-2xl opacity-60 group-hover:opacity-100 transition-opacity" />
