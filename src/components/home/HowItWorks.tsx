...
const steps = [
  {
    ...
    description: 'Choose Standard, Advanced, or Builder and select an account size from $25K to $150K.',
    bullets: [
      { label: 'Standard & Advanced', text: 'Begin in an evaluation phase' },
      { label: 'Builder', text: 'Evaluation with higher max loss limits than Standard' },
    ],
  ...
  },
  {
    ...
    icon: LineChart,
    title: 'Trade',
    description: 'Trade in a simulated environment using live futures market data on Volumetrica while following Dynasty Futures rules.',
    bullets: [
      { label: 'Standard & Advanced', text: 'Trade the evaluation to qualify for the funded phase' },
      { label: 'Builder', text: 'Follow Builder evaluation rules and qualify for funded trading' },
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      { label: 'Builder', text: 'After passing, traders follow funded-phase payout requirements' },
    ],
