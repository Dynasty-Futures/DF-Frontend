      ...
      <DialogContent className="bg-gradient-card border-border/50 max-w-md">
        ...
        <div className="space-y-4 text-sm md:text-base text-muted-foreground">
          ...
          <p>
            ...
            features and dashboards may be unavailable as we finalize
            infrastructure and operations.
          </p>
          <p>
            If you have questions or need assistance, our team is available to
            help.
          </p>
        </div>
        ...
        <DialogFooter className="flex flex-col-reverse sm:flex-row sm:justify-between sm:items-center gap-4 pt-2">
          ...
          <Button
            onClick={handleDismiss}
            className="bg-gradient-to-r from-primary to-primary text-primary-foreground font-semibold btn-glow w-full sm:w-auto"
          >
            Got it
          </Button>
        </DialogFooter>
